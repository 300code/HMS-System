...
<html lang="en">
	<head>
		<title>Админ | Специализация врача</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Админ | Добавить специализацию врача</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Админ</span>
									...
									<li class="active">
										<span>Добавить специализацию врача</span>
									</li>
								</ol>
							</div>
						</section>
						...
						<div class="container-fluid container-fullw bg-white">
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Специализация врача</h5>
												</div>
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Введите специализацию врача">
														</div>
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Управление <span class="text-bold">специализацией доктора</span></h5>
