...
<html lang="en">
	<head>
		<title>Админ | Изменить специализацию врача</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Админ | Изменить специализацию врача</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Админ</span>
									...
									<li class="active">
										<span>Изменить специализацию врача</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Изменить специализацию врача</h5>
												</div>
