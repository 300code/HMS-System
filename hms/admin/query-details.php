...
if($query){
echo "<script>alert('Замечание администратора успешно обновлено.');</script>";
...
<html lang="en">
	<head>
		<title>Админ | Подробности запроса</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Админ | Подробности запроса</h1>
																	</div>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Управлять <span class="text-bold">Подробности запроса</span></h5>
												<hr />
	...
	<tr>
												...
												<tr>
													...
													<td>	
														...
														Обновлять <i class="fa fa-arrow-circle-right"></i>
								</button>
