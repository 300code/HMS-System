	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2> ИСВТ | Вход для пациентов</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<p>
								Пожалуйста, введите свое имя и пароль для входа.<br />
							...
							<div class="form-actions">
								...
								<button type="submit" class="btn btn-primary pull-right" name="submit">
									Войдите <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
					...
					<div class="copyright">
						</span><span class="text-bold text-uppercase"> ИНФОРМАЦИОННАЯ СИСТЕМА ВРАЧА-ТЕРАПЕВТА</span>.
					</div>
